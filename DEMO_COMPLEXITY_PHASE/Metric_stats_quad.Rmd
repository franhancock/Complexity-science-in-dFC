---
title: "Linear Mixed Model for dFC Metrics - Quadratic Term for SYNC"
author: 
- name: "Fran Hancock"
...
# generate the model
fm <-lmer(PID ~ OCC + DUR + META + SYNC +I(SYNC^2) +SPEED + PCC + CHI + CENTROPY + (1|RUN), data=Regtb)
```
...
final_model<-lmer(PID ~ I(SYNC^2) + CENTROPY + CHI +(1|RUN), data=Regtb)
# Display final mdoel
